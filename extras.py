...
def dibujar(screen, palabraUsuario, palabraActual, puntos, segundos):
    ...
    #screen.blit(defaultFont.render("palabra anterior: "+palabraAnterior, 1, COLOR_TEXTO), (10, 150))
    #screen.blit(defaultFont.render("Posible opcion correcta: "+palabraCorrectaAnterior(dameUltimaSilaba(palabraUsuario),lemarioSilabasExpress()), 1, COLOR_TEXTO), (10, 150))
